                    ...
                    if ((command[1] == "P")) then
                        if ((command[2] ~= "") == true) and (command[2] ~= nil) then
                            if ((command[3] ~= "") == true) and (command[3] ~= nil) then
                                if ((command[4] ~= "") == true) and (command[4] ~= nil) then
                                    mqttOutMsg.Mode_from_server(command[1])
                                    mqttOutMsg.Cmd_from_server(command[2])
                                    mqttOutMsg.Date_rec_cmd(command[3])
                                    mqttOutMsg.Cmd_count(command[4])
                                    All_Motor.Run(command[2])
                                else
