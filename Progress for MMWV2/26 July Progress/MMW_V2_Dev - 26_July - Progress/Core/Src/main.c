...
dapat[1] = 78;
	if (strcmp(Rx_data_from_stc, Drop_Success) == 0){
		...
		Drop_Status = 0;
		Motor_Status = 1;
		sprintf(Tx_buff, "%.2f_door_%d_%d222\n", Temperature, Drop_Status, Motor_Status);
		statusreturn[0] = 3;
		statusreturn[1] = 3;
		HAL_UART_Transmit_IT(&huart1, Tx_buff, sizeof(Tx_buff));
	}
		...
		Drop_Status = 0;
		Motor_Status = 0;
		sprintf(Tx_buff, "%.2f_door_%d_%d333\n", Temperature, Drop_Status, Motor_Status);
		statusreturn[0] = 4;
		statusreturn[1] = 4;
		HAL_UART_Transmit_IT(&huart1, Tx_buff, sizeof(Tx_buff));
	}
		...
		Drop_Status = 0;
		Motor_Status = 1;
		sprintf(Tx_buff, "%.2f_door_%d_%d444\n", Temperature, Drop_Status, Motor_Status);
		statusreturn[0] = 5;
		statusreturn[1] = 5;
		HAL_UART_Transmit_IT(&huart1, Tx_buff, sizeof(Tx_buff));
	}
		...
		Drop_Status = 0;
		Motor_Status = 0;
		sprintf(Tx_buff, "%.2f_door_%d_%d555\n", Temperature, Drop_Status, Motor_Status);
		statusreturn[0] = 6;
		statusreturn[1] = 6;
		HAL_UART_Transmit_IT(&huart1, Tx_buff, sizeof(Tx_buff));
	}
		...
		Drop_Status = 0;
		Motor_Status = 0;
		sprintf(Tx_buff, "%.2f_0_%d_%dTEMP\n", Temperature, Drop_Status, Motor_Status);
		statusreturn[0] = 6;
		statusreturn[1] = 6;
		HAL_UART_Transmit_IT(&huart1, Tx_buff, sizeof(Tx_buff));
	}
		...
		Drop_Status = 0;
		Motor_Status = 0;
		sprintf(Tx_buff, "0_door_%d_%dDOOR\n", Temperature, Drop_Status, Motor_Status);
		statusreturn[0] = 6;
		statusreturn[1] = 6;
		HAL_UART_Transmit_IT(&huart1, Tx_buff, sizeof(Tx_buff));
	}
		...
		Drop_Status = 0;
		Motor_Status = 0;
		sprintf(Tx_buff, "%.2f_door_%d_%dSTAT\n", Temperature, Drop_Status, Motor_Status);
		statusreturn[0] = 6;
		statusreturn[1] = 6;
		HAL_UART_Transmit_IT(&huart1, Tx_buff, sizeof(Tx_buff));
	}
