...
-- ===========================================================
            if string.match(data.payload , "A1") then
                ...
                local A1 = "\x01\x05\x00\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xB2\x8A"
                uart.on(uartID)
            ...
            elseif string.match(data.payload , "A2") then
                pm.wake("UART_SENT2MCU")
                local A2 = "\x01\x05\x01\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x73\x1A"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "A3") then
                pm.wake("UART_SENT2MCU")
                local A3 = "\x01\x05\x02\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x33\xEB"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "A4") then
                pm.wake("UART_SENT2MCU")
                local A4 = "\x01\x05\x03\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xF2\x7B"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "A5") then
                pm.wake("UART_SENT2MCU")
                local A5 = "\x01\x05\x04\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xB0\x49"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "A6") then
                pm.wake("UART_SENT2MCU")
                local A6 = "\x01\x05\x05\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x71\xD9"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
...
-- ===========================================================
            elseif string.match(data.payload , "B1") then
                pm.wake("UART_SENT2MCU")
                local B1 = "\x01\x05\x0A\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x34\x2D"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "B2") then
                pm.wake("UART_SENT2MCU")
                local B2 = "\x01\x05\x0B\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xF5\xBD"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "B3") then
                pm.wake("UART_SENT2MCU")
                local B3 = "\x01\x05\x0C\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xB7\x8F"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "B4") then
                pm.wake("UART_SENT2MCU")
                local B4 = "\x01\x05\x0D\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x76\x1F"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "B5") then
                pm.wake("UART_SENT2MCU")
                local B5 = "\x01\x05\x0E\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x36\xEE"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "B6") then
                pm.wake("UART_SENT2MCU")
                local B6 = "\x01\x05\x0F\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xF7\x7E"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
...
-- ===========================================================
            elseif string.match(data.payload , "C1") then
                pm.wake("UART_SENT2MCU")
                local C1 = "\x01\x05\x14\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xBD\x85"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "C2") then
                pm.wake("UART_SENT2MCU")
                local C2 = "\x01\x05\x15\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x7C\x15"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "C3") then
                pm.wake("UART_SENT2MCU")
                local C3 = "\x01\x05\x16\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x3C\xE4"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "C4") then
                pm.wake("UART_SENT2MCU")
                local C4 = "\x01\x05\x17\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xFD\x74"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "C5") then
                pm.wake("UART_SENT2MCU")
                local C5 = "\x01\x05\x18\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xB8\x80"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "C6") then
                pm.wake("UART_SENT2MCU")
                local C6 = "\x01\x05\x19\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x79\x10"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
...
-- ===========================================================
            elseif string.match(data.payload , "D1") then
                pm.wake("UART_SENT2MCU")
                local D1 = "\x01\x05\x1E\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x3B\x22"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "D2") then
                pm.wake("UART_SENT2MCU")
                local D2 = "\x01\x05\x1F\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xFA\xB2"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "D3") then
                pm.wake("UART_SENT2MCU")
                local D3 = "\x01\x05\x20\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xAB\x52"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "D4") then
                pm.wake("UART_SENT2MCU")
                local D4 = "\x01\x05\x21\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x6A\xC2"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "D5") then
                pm.wake("UART_SENT2MCU")
                local D5 = "\x01\x05\x22\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x2A\x33"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "D6") then
                pm.wake("UART_SENT2MCU")
                local D6 = "\x01\x05\x23\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xEB\xA3"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
...
-- ===========================================================
            elseif string.match(data.payload , "E1") then
                pm.wake("UART_SENT2MCU")
                local E1 = "\x01\x05\x28\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xAC\x94"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "E2") then
                pm.wake("UART_SENT2MCU")
                local E2 = "\x01\x05\x29\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x6D\x04"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "E3") then
                pm.wake("UART_SENT2MCU")
                local E3 = "\x01\x05\x2A\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x2D\xF5"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "E4") then
                pm.wake("UART_SENT2MCU")
                local E4 = "\x01\x05\x2B\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xEC\x65"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "E5") then
                pm.wake("UART_SENT2MCU")
                local E5 = "\x01\x05\x2C\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xAE\x57"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "E6") then
                pm.wake("UART_SENT2MCU")
                local E6 = "\x01\x05\x2D\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x6F\xC7"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
...
-- ===========================================================
            elseif string.match(data.payload , "F1") then
                pm.wake("UART_SENT2MCU")
                local F1 = "\x01\x05\x32\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x27\xFF"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "F2") then
                pm.wake("UART_SENT2MCU")
                local F2 = "\x01\x05\x33\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xE6\x6F"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "F3") then
                pm.wake("UART_SENT2MCU")
                local F3 = "\x01\x05\x34\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xA4\x5D"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "F4") then
                pm.wake("UART_SENT2MCU")
                local F4 = "\x01\x05\x35\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x65\xCD"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "F5") then
                pm.wake("UART_SENT2MCU")
                local F5 = "\x01\x05\x36\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x25\x3C"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "F6") then
                pm.wake("UART_SENT2MCU")
                local F6 = "\x01\x05\x37\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xE4\xAC"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
...
-- ===========================================================
            elseif string.match(data.payload , "G1") then
                pm.wake("UART_SENT2MCU")
                local G1 = "\x01\x05\x3C\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xA3\x9B"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "G2") then
                pm.wake("UART_SENT2MCU")
                local G2 = "\x01\x05\x3D\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x62\x0B"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "G3") then
                pm.wake("UART_SENT2MCU")
                local G3 = "\x01\x05\x3E\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x22\xFA"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "G4") then
                pm.wake("UART_SENT2MCU")
                local G4 = "\x01\x05\x3F\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xE3\x6A"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "G5") then
                pm.wake("UART_SENT2MCU")
                local G5 = "\x01\x05\x40\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x83\x7A"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "G6") then
                pm.wake("UART_SENT2MCU")
                local G6 = "\x01\x05\x41\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x42\xEA"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
...
-- ===========================================================
            elseif string.match(data.payload , "H1") then
                pm.wake("UART_SENT2MCU")
                local H1 = "\x01\x05\x46\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xD8"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "H2") then
                pm.wake("UART_SENT2MCU")
                local H2 = "\x01\x05\x47\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xC1\x48"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "H3") then
                pm.wake("UART_SENT2MCU")
                local H3 = "\x01\x05\x48\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x84\xBC"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "H4") then
                pm.wake("UART_SENT2MCU")
                local H4 = "\x01\x05\x49\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x45\x2C"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "H5") then
                pm.wake("UART_SENT2MCU")
                local H5 = "\x01\x05\x4A\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x05\xDD"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "H6") then
                pm.wake("UART_SENT2MCU")
                local H6 = "\x01\x05\x4B\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xC4\x4D"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
...
-- ===========================================================
            elseif string.match(data.payload , "I1") then
                pm.wake("UART_SENT2MCU")
                local I1 = "\x01\x05\x50\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x8E\xB6"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "I2") then
                pm.wake("UART_SENT2MCU")
                local I2 = "\x01\x05\x51\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x4F\x26"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "I3") then
                pm.wake("UART_SENT2MCU")
                local I3 = "\x01\x05\x52\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x0F\xD7"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "I4") then
                pm.wake("UART_SENT2MCU")
                local I4 = "\x01\x05\x53\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xCE\x47"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "I5") then
                pm.wake("UART_SENT2MCU")
                local I5 = "\x01\x05\x54\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x8C\x75"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "I6") then
                pm.wake("UART_SENT2MCU")
                local I6 = "\x01\x05\x55\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x4D\xE5"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
...
-- ===========================================================
            elseif string.match(data.payload , "J1") then
                pm.wake("UART_SENT2MCU")
                local J1 = "\x01\x05\x5A\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x08\x11"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "J2") then
                pm.wake("UART_SENT2MCU")
                local J2 = "\x01\x05\x5B\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xC9\x81"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "J3") then
                pm.wake("UART_SENT2MCU")
                local J3 = "\x01\x05\x5C\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x8B\xB3"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "J4") then
                pm.wake("UART_SENT2MCU")
                local J4 = "\x01\x05\x5D\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x4A\x23"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "J5") then
                pm.wake("UART_SENT2MCU")
                local J5 = "\x01\x05\x5E\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x0A\xD2"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
            ...
            elseif string.match(data.payload , "J6") then
                pm.wake("UART_SENT2MCU")
                local J6 = "\x01\x05\x5F\x02\x02\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xCB\x42"
                uart.on(uartID)
                uart.setup(uartID,9600,8,uart.PAR_NONE,uart.STOP_1,nil,1)
