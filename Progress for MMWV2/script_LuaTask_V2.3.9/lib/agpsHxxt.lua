...
function updateEph()
    ...
    http.request("POST","52.80.18.70/rxn-api/locationApi/rtcm",nil,
    {["Authorization"]="RXN-BASIC cId=ZQWMDTvX2b,mId=uncorecomm,dId=12345678,pw=UE1JbUk1bnR1REhpZVFuYg==",
    ["Content-Type"]="application/json",
    ["Accept"]="application/octet-stream"},
    {
     "[{\"rtAssistance\":{\"format\":\"rtcm\",\"msgs\":[\"GPS:2NAF\",\"BDS:2NAF\",\"QZS:2NAF\"]}}]\r\n"
    },20000,downloadEphCb)
