...
local function main_loop()
    ...
    -- Defines the execution environment, and the print of the script entered under the command line is rewritten to the site on the command line
    local execute_env = {
        print = function(...)
			local arg = { ... }
...
--- Configure the serial parameters used by the console to create the console co-equation
...
function setup(id, baudrate)
    ...
    -- Wake up the console co-procedure when the serial port receives the data
