...
sys.taskInit(
    function()
        ...
        while true do
            ...
            --local SubPath = "/devices/SERVER/commands/#"
            local SubPath = "/devices/M2M/commands/#"
            local BoardID = "projects/cedar-abacus-328802/locations/asia-east1/registries/DEMO_PROG/devices/M2M"
            --setGpio5Fnc(1)
