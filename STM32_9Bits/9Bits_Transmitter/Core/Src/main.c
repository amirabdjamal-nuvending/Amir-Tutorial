...
uint8_t count1 = 0;
uint8_t Rx_data[6];
//uint16_t Tx1_data[5] = {0x001,0x005,0x000,0x0B1,0x048};
uint16_t Tx1_data[6] = {0x0FC,0x064,0x000,0x000,0x000,0x0FB};
uint16_t Tx2_data[5] = {0x002,0x005,0x000,0x0B2,0x049};
...
int main(void)
{
  ...
  while (1)
  {
    /* USER CODE END WHILE */
	  ...
	  if((count%10 == 0))
	  {
		  HAL_UART_Transmit_IT(&huart2, (uint8_t *)Tx1_data, 6);
	  	  count1++;
	  	  HAL_Delay (3000);
	  }
	  else
	  {
		  //HAL_UART_Transmit_IT(&huart2, (uint8_t *)Tx2_data, 5);
	  }
    /* USER CODE BEGIN 3 */
  }
  /* USER CODE END 3 */
