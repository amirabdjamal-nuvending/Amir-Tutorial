class Constant:
    ...
    RECEIVE_MONEY_METHOD_PAPER = bytearray(b'\x01')
    RECEIVE_MONEY_METHOD_COIN = bytearray(b'\x02')
    # ---------------------------------- END ----------------------------------
    ...
    PAYMENT_TYPE_CARD = bytearray(b'\x04')
    ...
    # ----------------------- 4.5.18 设置纸币接收面值  -------------------------
    CASH_COIN_SET_NOTE_ACCEPTANCE_COMMAND = bytearray(b'\x18')

    CASH_COIN_SET_NOTE_ACCEPTANCE_PARAMETER = bytearray(b'\x01')
    CASH_COIN_READ_NOTE_ACCEPTANCE_PARAMETER = bytearray(b'\x00')

    CASH_COIN_SET_NOTE_ACCEPTANCE_LENGTH = bytearray(b'\x04')
    CASH_COIN_READ_NOTE_ACCEPTANCE_LENGTH = bytearray(b'\x03')
    # -------------------------------- END ---------------------------------
    ...
    TEMPERATURE_CONTROLLER_SET_LENGTH = bytearray(b'\x07')
    # -------------------------------- END ---------------------------------
