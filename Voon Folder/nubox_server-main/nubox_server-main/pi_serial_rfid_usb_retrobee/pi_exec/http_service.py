...
from model.lifter_enable_result import LifterEnableResult
...
class HttpService:
    ...
    @staticmethod
    def get_lifter_enable() -> LifterEnableResult:
        url = f"{Constant.SERVER_ADDRESS}/getLifterEnableList"
        data = {}
        ...
        return LifterEnableResult.from_dict(result)

    @staticmethod
    def get_lifter_exist(row) -> bool:
        # print("get_lifter_exist")
        url = f"{Constant.SERVER_ADDRESS}/getLifterExist"
        data = {"row": row}
    ...
    def get_any_lifter_exist() -> bool:
        url = f"{Constant.SERVER_ADDRESS}/getAnyLifterExist"
